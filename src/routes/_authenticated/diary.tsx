...
export const Route = createFileRoute("/_authenticated/diary")({
  head: () => ({
    meta: [
      { title: `Diary Notes — ${PLATFORM_NAME}` },
      { name: "description", content: "Daily diary and notes for labour, expenses and reminders." },
      { property: "og:title", content: `Diary Notes — ${PLATFORM_NAME}` },
